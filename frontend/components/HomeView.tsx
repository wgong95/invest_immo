...
import { exportComparisonExcel, exportComparisonJson, exportComparisonPdf } from "@/lib/report";
...
const DEFAULT_PARAMS: Params = {
  ...
  prix_m2_achat: 11500,
  loyer_m2: 38.5,
  loyer_m2_meuble: 43.9,
  surface: 26.12,
  duree_pret_ans: 20,
  frais_notaire_pct: 8.08,
  ...
  tmi: 30,
  revalorisation_bien_pct: 1.9,
  revalorisation_loyer_pct: 1,
  horizon_ans: 25,
  rendement_scpi: 4,
  ...
  return [
    {
      ...
      loyer_m2_meuble: params.loyer_m2_meuble,
      ...
      const nextAnalyses = await Promise.all(
        enabledFlats.map(async (flat) => {
          const overridden: Params = {
            ...
            loyer_m2_meuble: flat.loyer_m2_meuble,
          ...
          <div className="space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => exportComparisonJson(params, analyses)}
